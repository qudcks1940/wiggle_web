  ...
  async function submit(allowDuplicate = false) {
    ...
    try {
      const payload = action === "join"
        ? { action, entry, nickname, animal, picturePassword: pictures, allowDuplicate, ...(classNumber ? { classNumber: Number(classNumber) } : {}) }
