...
**검증.** 운영 빌드(3301, 이 폴더 소유 확인)에서 쪽지 코드로 들어가 1689·1366·1180·1024·820·390 렌더: 가로 넘침 0, 이름 잘림 0, 태블릿 세로 스크롤 없음, 솔이로 시작 → `/student` 이동·서버 별명 "솔이"·🐰 저장. 시안과 나란히 보면 동물 질감은 맞고, 붓 이름 띠·몽그리·손글씨·해·무지개·꽃 장식은 아직 없다.
