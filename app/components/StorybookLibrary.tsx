...
export function StorybookLibrary() {
  ...
  return <main className="app-shell storybook-library">
    ...
    <section className="storybook-library-hero"><div><p className="eyebrow">내 그림과 글을 한 권에</p><h1>AI 그림책 만들기</h1><p>완성한 그림을 가져오고, 새 이미지와 이야기를 원하는 곳에 놓아 봐요.</p></div><span aria-hidden="true">📖✨</span></section>
