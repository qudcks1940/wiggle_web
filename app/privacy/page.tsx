  ...
  return (
    <main className="policy-page">
      ...
      <article className="policy-body">
        ...
        <h2>1. 학생 이름은 학급 명단에만 있습니다</h2>
        <ul>
          <li>학생의 이메일, 학교 이름, 생년월일을 <b>수집하지 않습니다.</b></li>
          <li>담임 선생님이 학급을 만들 때 <b>명단(출석번호와 이름)</b>을 직접 입력합니다.
            이 명단은 <b>그 학급의 담임 선생님 화면에서만</b> 보이며, 학생 화면·가족 공유·그림책·AI 요청에는
            학생 이름을 싣지 않습니다.</li>
          <li>학생은 수업 코드나 학급 QR로 들어와 자기 번호를 입력하고,
            동물 그림·별명·그림 비밀번호만으로 참여합니다.</li>
          <li>학급을 삭제하면 명단도 함께 삭제됩니다.</li>
        ...
        <ul>
          ...
          <li>AI 도우미(몽그리)는 아이가 부를 때만 답하며, 그림을 대신 그리거나 평가하지 않습니다.</li>
        </ul>
